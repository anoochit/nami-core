...
/// Fetches live model names for a given provider from OpenRouter API (no auth needed).
/// Falls back to hardcoded curated lists on network errors.
/// Always appends "custom" as the last entry.
