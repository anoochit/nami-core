...
pub(crate) use download::download_skills;
pub(crate) use helpers::{merge_toml, write_file, write_file_if_not_exists};
...
"#
    ...
    let api_key_env = crate::utils::provider_env_var(&provider);
